...
data_file = open('/Users/fangchi/PycharmProjects/python_project/marchineLearning/ch3/3.5/data.csv')
...
0-1之间的浮点数:固定的收缩参数 （注意收缩只在'lsqr'和'eigen'时才有效）
'''
lda_model = LinearDiscriminantAnalysis(solver='lsqr', shrinkage=0.001).fit(X_train, y_train)
# model validation
...
from self_def_3_5 import GetProjectivePoint_2D
